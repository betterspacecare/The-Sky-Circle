...
import { Telescope, Mail, Lock, Loader2, UserPlus } from 'lucide-react'
            ...
            <div className="w-full max-w-md">
                ...
                <div className="glass-effect rounded-3xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleEmailSignup} className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="confirmPassword" className="block text-[10px] font-black uppercase tracking-widest text-white/40 mb-2">
                                Confirm Password
                            </label>
                            <div className="relative">
                                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/30" />
                        ...
                        <div>
                            <label htmlFor="referralCode" className="block text-[10px] font-black uppercase tracking-widest text-white/40 mb-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 py-4 glass-inner rounded-2xl focus:outline-none focus:ring-2 focus:ring-cosmic-purple/50 transition-all uppercase text-white placeholder:text-white/20"
                    ...
                    <p className="text-center text-sm text-white/40 mt-6">
                        ...
                        <Link href="/login" className="text-cosmic-purple hover:text-cosmic-pink font-bold transition-colors">
                            Sign in
                        </Link>
                    </p>
                </div>
