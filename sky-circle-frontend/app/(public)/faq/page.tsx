...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden">
      ...
      {/* Hero Section */}
      <div className="relative py-20 sm:py-32 px-4 overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 glass-effect rounded-2xl focus:outline-none focus:ring-2 focus:ring-cosmic-purple/50 transition-all text-white placeholder:text-white/30"
              />
            </div>
          </div>
        </div>
      ...
      {/* FAQ Content */}
      <div className="max-w-5xl mx-auto px-4 py-12 sm:py-16 flex-1">
              ...
              <div key={categoryIndex}>
                ...
                <div className="space-y-3">
                  {category.questions.map((faq, index) => {
                    ...
                    return (
                      <div key={index} className="glass-effect rounded-2xl overflow-hidden hover:bg-white/5 transition-colors">
                        <button
                          onClick={() => setOpenIndex(isOpen ? null : itemId)}
                          className="w-full px-6 py-5 flex items-center justify-between text-left"
                        >
                          <span className="font-bold text-base sm:text-lg pr-4 flex-1">{faq.question}</span>
                          <ChevronDown 
        ...
        {/* Contact Section */}
        <div className="mt-16 glass-effect rounded-2xl p-8 sm:p-12 text-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cosmic-purple to-cosmic-pink flex items-center justify-center mx-auto mb-6">
            <Mail className="w-8 h-8 text-white" />
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Still have questions?</h2>
          <p className="text-white/70 mb-6 max-w-xl mx-auto">
            Can't find the answer you're looking for? Our support team is here to help you explore the cosmos.
          </p>
          <a
            href="mailto:hello@theskycircle.com"
            className="inline-block px-8 py-4 bg-gradient-to-r from-cosmic-purple to-cosmic-pink rounded-full font-semibold hover:scale-105 transition-transform shadow-lg"
          >
            Contact Support
          </a>
        </div>
