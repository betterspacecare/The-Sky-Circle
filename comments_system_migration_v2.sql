-- Comments System Migration V2
-- Simplified migration that handles all edge cases
...
-- Step 10: Create function to update post comments count
...
-- Step 11: Create trigger for post comments count
CREATE TRIGGER update_post_comments_count_trigger
    AFTER INSERT OR DELETE ON comments
    FOR EACH ROW
    EXECUTE FUNCTION update_post_comments_count();

-- Step 12: Add comments_count column to posts table if it doesn't exist
DO $$ 
BEGIN
    IF NOT EXISTS (
...
-- Step 13: Initialize comments_count for all existing posts
UPDATE posts SET comments_count = 0 WHERE comments_count IS NULL;

-- Migration complete!
-- The comments system is now ready to use.
